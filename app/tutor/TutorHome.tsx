...
type TutorRoutes =
  | '/tutor/AgendarCita'
  | '/tutor/CitasAgendadas'
  | '/tutor/CitasAnteriores'
  | '/tutor/Buzon';
...
const TUTOR_OPTIONS: OptionItem[] = [
  { label: 'Agendar Cita', icon: 'plus', route: '/tutor/AgendarCita' },
  { label: 'Citas Agendadas', icon: 'calendar', route: '/tutor/CitasAgendadas' },
  { label: 'Historial', icon: 'clock', route: '/tutor/CitasAnteriores' },
  { label: 'Buzón', icon: 'mail', route: '/tutor/Buzon' },
];
...
export default function TutorHome() {
  ...
  const handleNavigation = (route: TutorRoutes) => {
    router.push(route);
  };
      ...
      <View style={styles.content}>
        <View style={styles.welcomeSection}>
          <View style={styles.welcomeContainer}>
            ...
            <Text style={styles.subtitle}>Gestión de citas y tutorías</Text>
          </View>
        </View>
